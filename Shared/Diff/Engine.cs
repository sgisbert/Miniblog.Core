...
namespace Shared.Diff
{
    ...
    public class DiffEngine
    {
        ...
        /// <summary>
        /// Inicializa una nueva instancia de la class <see cref="DiffEngine"/>.
        /// </summary>
        /// 06/04/2012 by Juanda
        public DiffEngine()
        {
        ...
        private void GetLongestSourceMatch(DiffState curItem, int destIndex, int destEnd, int sourceStart, int sourceEnd)
        {
            ...
            {
                maxLength = System.Math.Min(maxDestLength, (sourceEnd - sourceIndex) + 1);
            ...
            int nextSource)
        {
            ...
            if (diffDest > 0)
            {
                if (diffSource > 0)
                {
                    minDiff = System.Math.Min(diffDest, diffSource);
